Module opticomp.objective_zoo
=============================

Sub-modules
-----------
* opticomp.objective_zoo.ackley_function
* opticomp.objective_zoo.griewank_function
* opticomp.objective_zoo.rosenbrock_function
* opticomp.objective_zoo.sphere_function

Functions
---------

    
`fetch_ackley_function()`
:   Ackley function
    -----------
